...
from generate_v2b_cache_refresh import generate_with_dual_cache_v2b_refresh
...
generate_module.generate_with_dual_cache = (
    generate_with_dual_cache_v2b_refresh
)


print("=" * 80)
print("Rotated-K v2b cache-refresh enabled")
