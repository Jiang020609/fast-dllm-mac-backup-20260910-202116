...
from generate_v2b_coarse_profile import generate_with_dual_cache_v2b_profiled
...
generate_module.generate_with_dual_cache = (
    generate_with_dual_cache_v2b_profiled
)


print("=" * 80)
print("Rotated-K v2b coarse profile enabled")
