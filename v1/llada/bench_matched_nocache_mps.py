...
def main() -> None:
    ...
    raw_path = results_dir / f"mac_b2_control_nocache_{args.run_id}_raw.csv"
    summary_path = results_dir / f"mac_b2_control_nocache_{args.run_id}_summary.csv"
    error_path = results_dir / f"mac_b2_control_nocache_{args.run_id}_errors.csv"

    print("===== Mac-B2-Control Matched No-Cache =====", flush=True)
