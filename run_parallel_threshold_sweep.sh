...
OUTROOT="$HOME/Fast-dLLM/results/parallel_threshold_$RUN_ID"
LOGROOT="$HOME/Fast-dLLM/logs/parallel_threshold_$RUN_ID"
...
echo "============================================================"
echo "Fast-dLLM Parallel-only threshold sweep"
echo "Run ID: $RUN_ID"
echo "Started: $(date)"
...
do
    ...
    MODEL_ARGS="model_path=$MODEL,device=mps,is_check_greedy=False,gen_length=256,steps=256,block_length=32,show_speed=True,threshold=$THRESHOLD"
...
summary_path = outroot / "parallel_threshold_summary.csv"
...
print()
print("=" * 80)
print("Parallel-only threshold sweep summary")
print("=" * 80)
...
echo
echo "============================================================"
echo "Parallel-only sweep completed"
