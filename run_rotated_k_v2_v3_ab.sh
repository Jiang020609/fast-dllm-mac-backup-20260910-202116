...
OUTROOT="$HOME/Fast-dLLM/results/rotated_k_v2_v3_ab_$RUN_ID"
LOGROOT="$HOME/Fast-dLLM/logs/rotated_k_v2_v3_ab_$RUN_ID"
...
for REPEAT in $(seq 1 "$REPEATS"); do
    for MODE in v2 v3; do
        if [ "$MODE" = "v2" ]; then
            ...
            TARGET="$ROOT/eval_llada_rotated_k_v3_wrapper.py"
        fi
...
echo
echo "=================================================="
echo "Rotated-K v2/v3 A/B completed"
